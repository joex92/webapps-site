...
<html>
    ...
    <body>
        ...
        <img src="joex-logo.png" style="float: left; zoom: 0.1; padding: 50px; margin: 50px">
        <p id="hi"><br>Hi, I'm <b style="color: #C00;">Joe X!</b><br>
        I'm from <font style='color: #FF0;'>Ecu</font><font style='color: #88F;'>ad</font><font style='color: #F00;'>or</font>, I'm a Music Producer, Audiovisual experimental artist, Geek and Gamer!<br>
        In this minimalistic website I'll be updating my portfolio.<br>
        You can check the source code of this page on my <a href="https://github.com/joex92/webapps-site" target="_blank" style="color: #AAA;">Github page.</a>(If i haven't forgotten to upload there)</p>
