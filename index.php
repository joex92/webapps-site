...
<html>
        ...
        <script>
            ...
            window.onload = (e) => {
                ...
                constructor(effect, x, y, color){
                    ...
                    this.force = -Math.min(innerHeight*300, innerWidth*300) / this.distance;
                ...
                update(){
                    if ( this.effect.centerX != (innerWidth / 2) ) {
                      this.effect.originX -= this.effect.centerX - (innerWidth / 2);
                      this.effect.centerX = innerWidth / 2;
                    }
                    if ( this.effect.centerY != (innerHeight / 2) ) {
                      this.effect.originY -= this.effect.centerY - (innerHeight / 2);
                      this.effect.centerY = innerHeight / 2;
                    }
    ...
    <body>
        ...
        <img id="logo" src="joex-logo.png" style="float: left; zoom: 0.2; padding: 10em; margin: 0">
        <!-- <img id="logo" src="JXM-logo.png" style="float: left; zoom: 0.1; padding: 50px; margin: 50px"> -->
        <p id="hi"><br>Hi, I'm<b class='notranslate' style="color: #C00;"> Joe X!</b>, my real name is <i>José Andrés Medina Ochoa</i> and I'm from<font class='notranslate' style='color: #FF0;'> Ecu</font><font class='notranslate' style='color: #88F;'>ad</font><font class='notranslate' style='color: #F00;'>or</font><br>
